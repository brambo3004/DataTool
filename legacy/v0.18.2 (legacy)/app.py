                ...
                if comparison.empty:
                    ...
                    if action_list.empty:
                        ...
                        with filter_row_1[3]:
                            duiding_options = [
                                "Alle duidingen",
                                *sorted(action_list.get("duiding", pd.Series(dtype=str)).dropna().astype(str).unique()),
                            ]
                            selected_duiding = st.selectbox(
                                "Filter duiding",
                                duiding_options,
                                key=f"fase4_duiding_{selected_road}",
                            )

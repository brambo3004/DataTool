...
v0.37.0 start de inhoudelijke kalibratiefase voor N354. De Project Adviseur
basis uit v0.36.x blijft intact: de projectvoorstellen worden nog niet
automatisch aangepast. Deze versie voegt een gericht kalibratierapport toe:

`Projectadvies_Kalibratie_<weg>.xlsx`

Doel van dit rapport:
- automatisch aanwijzen waar de huidige onderhoudscomplexlogica waarschijnlijk
  te fijn knipt;
- korte reguliere voorstellen zichtbaar maken als kandidaat voor inhoudelijke
  samenvoegregels;
- dubbele voorgestelde projectnamen signaleren;
- objectfamilie-mismatches tonen, bijvoorbeeld fietspadobjecten in HRB-context;
- technische knipredenen samenvatten;
- afwijkende hectometerintervallen als grenscontext bewaren, niet als
  onderhoudslogica.
...
- tests toegevoegd voor korte voorstellen, dubbele projectnamen,
  objectfamilie-mismatches en Excel-export van het kalibratierapport.

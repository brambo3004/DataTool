...
1. **Kalibratierapport Project Adviseur toegevoegd**
   - Nieuwe export `Projectadvies_Kalibratie_<weg>.xlsx`.
   - De export is bedoeld om N354-inhoudelijke kalibratie automatisch te ondersteunen.
   - De projectvormingsengine wordt nog niet aangepast.

2. **Automatische signalering van mogelijke versnippering**
   - Korte reguliere voorstellen worden apart gerapporteerd.
   - Dubbele voorgestelde projectnamen worden apart gerapporteerd.
   - Objectfamilie-mismatches worden apart gerapporteerd.
   - Technische knipredenen worden geteld per veld en projecttype.
   - Afwijkende hectometerintervallen blijven als contextlaag beschikbaar.
